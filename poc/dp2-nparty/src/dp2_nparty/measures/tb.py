...
- t_rtt_ms: 네트워크 왕복 1회 (근거리 무선 왕복 잠정 50ms — 분석자 제안)
- t_eval_ms: 후보 1건 순위표 구축 (**PoC 실측 기반 0.003ms**, 아래 참조)
- bw_bytes_per_s: 전송 대역 (1 Mbps 급 잠정 125,000 B/s — 분석자 제안)
...
DEFAULT_CONSTANTS = {"t_rtt_ms": 50.0, "t_eval_ms": 0.003, "bw_bytes_per_s": 125_000.0}
