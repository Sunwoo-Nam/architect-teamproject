...
| TC | 이름 | 목적 / 특징 |
|---|---|---|
| S01 | 기준 | 2인 영화+저녁, 기본 케이스 |
| S02 | 취향 유사 | 두 사람 취향 상관 +0.7 — 빠른 수렴 |
| S03 | 취향 상극 | 상관 −0.7 — 1안 조기 좁힘 vs 2안 관전점 |
| S04 | 독립 축 | 의존성 없는 순수 조합 폭발 (대조군) |
| S05 | 부드러운 의존 | 소프트 의존 — 2안 재채점 vs 1안 순서 처리 |
| S06 | 역방향 의존 | 인기작이 특정 시간만 상영 — **1안 약점 자극** |
| S07 | 빡빡한 제약 | 유효 교집합 극소수 — 백트랙·압축 한계 |
| S08 | 합의 불가능 | 하드 교집합 공집합 — **정상 결렬이 정답** |
| S09 | 6축 확장 | 날짜·시간·지역·영화·식당·메뉴 |
| S10 | 비대칭 2인 | 제약 많은 1인 vs 무관심한 1인 |
| S11 | 축 수 스윕 | 하루 풀 플랜, 축 4/6/8/10 |
| S12 | 고아 강제 | 지역당 후보 다수(식당·영화관 3개) — **2안 압축의 고아 유발** |
