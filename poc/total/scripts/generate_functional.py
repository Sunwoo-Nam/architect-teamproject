...
사용 (poc/total 에서 실행):
    python scripts/generate_functional.py --pilot
    python scripts/generate_functional.py --participants 3 --per-type 20
    python scripts/generate_functional.py --participants 5 --per-type 6 --start 1
"""
