...
# [이식 시 수정] 데이터셋이 poc/total/datasets/nparty 로 옮겨졌다 — 원본 경로는
# poc/dp2-nparty/data/benchmark 였다. 이 상수 외에는 원본을 건드리지 않았다.
DATA_DIR = Path(__file__).resolve().parents[5] / "datasets" / "nparty"
...
FOREIGN_SCHEMA_DIRS = ("issue-space", "issue-space-b", "issue-space-n")
