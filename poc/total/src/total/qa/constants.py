...
# (구 BAND_FC_ACHIEVED 폐기 — 별점은 s 단일, PL 확정 2026-08-13. 달성률은 수치 병기만)
...
BAND_SC_MAX_ISSUES = Band(
    ...
    direction="at_least",
    note="24 §4.3 (PL 확정 2026-08-13) — 참조점: 하한 4축(요구 — 기준 시나리오 날짜·시간·"
         "영화관·영화, 미달 즉시 결함) · 상한 12축(실사용 최대 — 여행급 협의의 축 열거와 "
         "인지 한계·자동 협상 벤치마크 근거, 24 §4.3-a). [4,12] 로그 5등분(4·5.0·6.2·7.7·"
         "9.6·12)의 반올림",
)
