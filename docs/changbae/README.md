...
| 08 | 빈도 상위(4 이상) 핵심 QA 12종 집중 평가 → (H,H) 교집합으로 **최우선 QA 11종 선정** + 설계 질문 9가지 | [`08-핵심-QA-중요도-난이도-평가.md`](08-핵심-QA-중요도-난이도-평가.md) |
...
| 10 | 최우선 QA 11종의 **측정 지표·목표 수준·테스트 환경·방법** 정의 | [`10-핵심-QA-측정-계획.md`](10-핵심-QA-측정-계획.md) |
...
- **최우선 QA 11종** (08 §8.3): 빈도 상위 12종 ∩ (H,H) 11종 = 교집합 9종 — 기능 정확성·결함 감내·확장성·시간 효율성·복구 가능성·시험 용이성·자원 효율성·기밀성·운용 제약 준수 — 에 (H,H) 단독 2종(공존성·운용성/사용자 통제)을 더한 11종이 아키텍처 결정의 1차 드라이버.
...
- **측정 체계** (10): 최우선 QA 11종 각각에 지표·목표 수준(절대 기준 vs 파일럿 목표)·테스트 환경(Mock 시뮬레이션 / 실기기 / 사용자 평가)·방법을 정의 — QAS 작성의 원천.
