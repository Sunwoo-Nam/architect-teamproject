...
| 24 | **QA 측정 핸드북 (전 측정 항목 통합 정본)** — 핵심 QA 5(§1 FC · §2 RU-메모리 · §3 SC-참여자 · §4 SC-의제 · §5 FT&REC) + 비핵심 3(§6 TB · §7 CF · §8 AN) + 관측량(§9 전송 횟수·크기·phase). 항목별 개별 문서(구 24-29)는 통합 후 폐지 | [`24-QA-측정-핸드북.md`](24-QA-측정-핸드북.md) |
