...
| 24 | **Functional Correctness 정의·측정 (정본)** — Total Utility 달성률 = U(도달 결과)÷U(최적 후보 x\*), initial/revised threshold 구분, 결렬 포함 채점, 목표는 무작위 베이스라인 유의 우위 → 파일럿 후 절대값 고정 | [`24-Functional-Correctness-정의-측정.md`](24-Functional-Correctness-정의-측정.md) |
