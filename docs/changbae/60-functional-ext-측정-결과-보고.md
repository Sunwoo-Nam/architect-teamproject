...
| **3. 기밀성** — 최악 관찰자에게 노출되는 내 선호 비율 (낮을수록 좋음) | **31.7% ★4** | 48.3% ★3 | **방안 1-A** |
...
| CF | **후보안 노출률** = 최악 관찰자 노출 깊이 — 합의 세션의 피해자 평균 | ≤20% ★5 / ≤40% ★4 / ≤60% ★3 / ≤80% ★2 / <100% ★1 / 100% ★0 | 무노출 0% - 전량 공개 100% 20%p 등분, 경계 포함(≤) — TB·RU와 통일 | 2026-08-14 |
...
- **1:1 참조점**: 같은 판에서 2인 협상의 실측 노출 = 29.2% (e₂ = 0.2917). "★4 이상 = 1:1 협상 수준"으로 읽는다.
...
| FR 위반 | 0건 | 0건 |
| CF 노출률 (판정 — 합의 세션 384건 평균) | 31.7% ±19.4 **★4** | 48.3% ±23.7 **★3** |
...
|---|---|---|---|---|---|---|---|
| 3 | 0.938 (★4) | 0.954 (★5) | 11/24/25 | 20% (★5) | 29% (★4) | 0.606 (★2) | **0.867 (★1)** |
...
| 15 | 0.858 (★3) | 0.952 (★5) | 1/24/35 | 31% (★4) | 48% (★3) | 0.153 (★5) | 0.198 (★5) |
| 20 | 0.848 (★2) | 0.937 (★4) | 2/24/34 | 33% (★4) | 50% (★3) | 0.115 (★5) | 0.157 (★5) |
| 30 | 0.842 (★2) | 0.944 (★4) | 0/24/36 | 33% (★4) | 50% (★3) | 0.083 (★5) | 0.110 (★5) |
| 50 | 0.835 (★2) | 0.949 (★4) | 0/24/36 | 33% (★4) | 50% (★3) | 0.051 (★5) | 0.068 (★5) |
...
|---|---|---|---|---|---|
| wide_common | 0.795 (★1) | 0.947 (★4) | 9/0/87 | 26% (★4) | 52% (★3) |
| utility_tradeoff | 0.671 (★0) | 0.803 (★2) | 20/0/76 | 36% (★4) | 51% (★3) |
